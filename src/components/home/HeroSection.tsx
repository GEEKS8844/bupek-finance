  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#0F2D52] via-[#1a3f63] to-[#0F2D52] pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-20 left-10 w-80 h-80 bg-[#2563EB] opacity-5 rounded-full blur-3xl"
          animate={{ y: [0, -30, 0], x: [0, -20, 0] }}
        ...
        >
          ...
          <div className="space-y-8">
            ...
            >
              <Button
                size="lg"
                className="bg-[#D4AF37] hover:bg-[#c99a2e] text-[#0F2D52] font-semibold group"
              >
                Apply for Loan
          ...
          <motion.div variants={item} className="relative h-96 lg:h-full">
            {floatingStats.map((stat, index) => (
              <motion.div
                ...
                className={`absolute bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 text-center text-white
                  ${
                    index === 0
                      ? 'top-0 right-0 w-48 h-48'
                      : index === 1
                        ? 'top-1/2 right-1/3 w-56 h-56 -translate-y-1/2'
                        : 'bottom-10 right-10 w-48 h-48'
                  }
                `}
              >
                <motion.div
