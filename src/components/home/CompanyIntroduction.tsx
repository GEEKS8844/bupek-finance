        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-[#0F2D52] mt-3">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-4">
              {['Trust', 'Innovation', 'Impact', 'Excellence'].map((value, i) => (
                <motion.div
                  ...
                  className="bg-[#F8FAFC] rounded-lg p-3 sm:p-4 border-l-4 border-[#D4AF37]"
                >
                  <p className="font-semibold text-[#0F2D52] text-sm sm:text-base">{value}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
            ...
            {highlights.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-gradient-to-br from-[#F8FAFC] to-white rounded-2xl p-6 sm:p-8 border border-gray-100 hover:border-[#D4AF37] hover:shadow-xl transition-all duration-300 group"
                >
                  <motion.div
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-[#0F2D52] mb-2">
                    {item.value}
                  </p>
